...
python train.py --num_epochs=100 --untrain_num_epochs=30 --batch_size=128 --data_dir='/home/gasanoe/HOME_SCRATCH_FOLDER/unlearning/media/cifar100' --learning_rate=0.1 --log_dir='/home/gasanoe/HOME_SCRATCH_FOLDER/unlearning/logs/' --model='resnet18' --use_sam --rho=0.5
